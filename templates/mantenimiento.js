                          ...
                          <tbody>
                            <tr>
                              <td style="width:595px;">
                                <img height="auto" src="https://enerjet.com.pe/mailings/2022/gardi_mantenimiento/banner.jpg" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="595" />
                              </td>
                            </tr>
                          </tbody>
                        </table>
                    ...
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:center;color:#000000;">
                          <h1>¡Hola ${name}!</h1> Es momento de realizar la revisión/mantenimiento de tu batería Enerjet ${qr_code} y, asegurar su óptimo estado. Te sugerimos acercarte al centro donde realizaste la instalación de tu batería:
                        </div>
                      </td>
                    </tr>
                  </tbody>
              ...
              <div class="mj-column-per-33-333333333333336 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tbody>
                    ...
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:center;color:#000000;">FECHA DE MANTENIMIENTO <br/> ${maintenance_date}</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
